    ...
    while True:
        ...
        if len(contours) > 0:
            ...
            if cv2.contourArea(contour) > 10000 and frames > 50:
                ...
                cv2.putText(frame, "Capturing..", (20, 40), FONT_HERSHEY_COMPLEX, 2, (127, 255, 255))
                cv2.imwrite("gestures/" + str(gesture_id) + "/" + str(pic_count) + ".jpg", save_img)

        cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
        cv2.putText(frame, str(pic_count), (30, 200), FONT_HERSHEY_COMPLEX, 1.5, (127, 127, 255))
